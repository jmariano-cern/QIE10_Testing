...
// --- Suite 0: "full" ---
  ...
  if (suite_code == 0) {
    ...
    if (val < 8 ) {
      if (global.corrupt == 0) {
        if (_event_num > 2) {
          TH2F_perEVs[9]->Fill ( global.ici2q[(int)val] , global.qsum );
        }
      }
    }
    if (global.corrupt == 0) {
      if (_event_num > 2) {
        TH2F_perEVs[10]->Fill ( val , global.qmax / global.qsum );
      }
    }
    if ( global.corrupt == 0 ) {
      if (_event_num > 2) {
        TH2F_perEVs[11]->Fill ( val , global.qsum );
      }
    }
    if (global.qmax3 > -1) {
      if ( global.corrupt == 0 ) {
    ...
    if (val < 8 ) {
      if (global.corrupt == 0) {
        if (_event_num > 2) {
          TH2F_perCHs[9][nCH]->Fill ( global.ici2q[(int)val] , global.qsum );
        }
      }
    }
    if (global.corrupt == 0) {
      if (_event_num > 2) {
        TH2F_perCHs[10][nCH]->Fill ( val , global.qmax / global.qsum );
      }
    }
    if ( global.corrupt == 0 ) {
      if (_event_num > 2) {
        TH2F_perCHs[19][nCH]->Fill ( val , global.qsum );
      }
    }
    if (global.qmax3 > -1) {
      if ( global.corrupt == 0 ) {
        if (_event_num > 2) {
          TH2F_perCHs[20][nCH]->Fill ( val , global.qmax3 / global.qsum );
        }
      }
    }
    if (global.qmax3 > -1) {
      if ( global.corrupt == 0 ) {
        if (_event_num > 2) {
          TH2F_perCHs[22][nCH]->Fill ( val , (global.qmax3) / global.qsum );
        }
      }
    }
    if ( global.corrupt == 0 ) {
...
// --- Suite 6: "ICIScanner" ---
  ...
  if (suite_code == 6) {
    ...
    if (val < 8 ) {
      if (global.corrupt == 0) {
        if (_event_num > 2) {
          TH2F_perCHs[0][nCH]->Fill ( global.ici2q[(int)val] , global.qsum );
        }
      }
    }
    if (global.corrupt == 0) {
      if (_event_num > 2) {
        TH2F_perCHs[1][nCH]->Fill ( val , global.qmax / global.qsum );
      }
    }
