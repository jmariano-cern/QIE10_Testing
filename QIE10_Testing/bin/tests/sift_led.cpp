...
void sift_led(Int_t run0_num, Int_t run1_num, Int_t run2_num) {
  ...
  sprintf(file0_name,"../../dat/QIE10testing_%i_7.root",run0_num);
  _file0 = TFile::Open(file0_name);
  sprintf(file1_name,"../../dat/QIE10testing_%i_8.root",run1_num);
  _file1 = TFile::Open(file1_name);
  sprintf(file2_name,"../../dat/QIE10testing_%i_5.root",run2_num);
