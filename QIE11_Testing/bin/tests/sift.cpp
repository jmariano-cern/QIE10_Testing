...
void sift(Int_t run0_num, Int_t run1_num) {
  ...
  sprintf(file0_name,"../../dat/QIE11testing_%i_1.root",run0_num);
  _file0 = TFile::Open(file0_name);
  sprintf(file1_name,"../../dat/QIE11testing_%i_4.root",run0_num);
  _file1 = TFile::Open(file1_name);
  sprintf(file2_name,"../../dat/QIE11testing_%i_6.root",run1_num);
